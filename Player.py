...
class Player(tk.Frame):
    ...
    def track_widgets(self):
        self.canvas = tk.Label(self.track, image=self.img)
    ...
    def control_widgets(self):
        ...
        self.prev = tk.Button(self.controls, image=self.previ)
        self.prev['command'] = self.prev_song
        self.prev.grid(row=0, column=1)

        self.pause = tk.Button(self.controls, image=self.pausei)
        self.pause['command'] = self.pause_song
        self.pause.grid(row=0, column=2)

        self.next = tk.Button(self.controls, image=self.next_i)
